...
namespace Core.Interfaces
{
    public interface ISummaryReportService
    {
        ...
        byte[] MergeFixedStructureReportsToExcel(List<Report> reports, string templatePath, int year, int month, List<int> rowRanges);
        byte[] MergeSummaryExcelReport(List<Report> reports, string templatePath, int year, int month, List<int> selectedRowIndexes);
    }
}